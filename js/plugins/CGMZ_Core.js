 ...
 * rename the js file.
 * --------------------------Latest Version------------------------------------
 * Hi all, this latest version adds some new sprite classes to help other
 * [CGMZ] plugins display animated sprites, such as walk and battle sprites.
 * These are mostly meant for windows but may be used elsewhere as well.
 *
 * This version also added some tracking for the selection window index, which
 * will allow [CGMZ] plugins to know what the previous index was as well.
 *
 * Version 1.29.0
...
var CGMZ = {};
CGMZ.Versions = {};
CGMZ.Versions["CGMZ Core"] = "1.29.0";
CGMZ.Core = {};
...
CGMZ_Video.play = function(src) {
    this._element.src = "movies/" + src + this.videoFileExt();
...
// Get extension
//-----------------------------------------------------------------------------
CGMZ_Video.videoFileExt = function() {
